package com.ironhack.whatscookingserver.security;

import com.ironhack.whatscookingserver.filter.CustomAuthenticationFilter;
import com.ironhack.whatscookingserver.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable();
        http.cors(); //this is to avoid issues between spring security and cors
