...
public class WhatsCookingServerApplication {
	...
	CommandLineRunner run(PasswordEncoder passwordEncoder, UserRepository userRepository, CookbookRepository cookbookRepository, RecipeRepository recipeRepository, NoteRepository noteRepository) {
		return args -> {
			...
			user3.setPassword(passwordEncoder.encode(user3.getPassword()));
			User user7 = new User("Tamara", "tamarat@email.com", "P@ssw0rdtamara");
			user3.setPassword(passwordEncoder.encode(user3.getPassword()));
			...
			Recipe recipe4 = new Recipe("Honey Garlic Salmon", 5, 20, 4, "1/3 c. honey, 1/4 c. low-sodium soy sauce, " +
					...
					"by about 1/3. Baste salmon with the sauce. 4. Garnish with sliced lemon and serve.", user4);
			Recipe recipe5 = new Recipe("Sausage and Vegetables", 15, 60, 4, "3/4 lb. baby potatoes sliced, 1 medium " +
					...
					"tender, another 20 to 25 minutes more.", user5);
			...
			Recipe recipe8 = new Recipe("Grilled Cheese", 5,15,2, "5 tbsp. butter softened, 4 slices sourdough bread, " +
					...
					"wiping skillet clean if necessary.", user8);
			Recipe recipe9 = new Recipe("Garlic Lemon Tilapia", 5, 20, 4, "4 (6-oz.) tilapia fillets, Kosher salt, Freshly " +
					...
					"tilapia until fork-tender, 10 to 12 minutes.", user9);
			Recipe recipe10 = new Recipe("Pickles", 5, 120, 10, "1 lb. Kirby or Persian cucumbers, 3 cloves garlic, " +
					...
					"1. Trim ends from cucumbers and slice into spears. Pack into 2 (16-oz. glass jar along with garlic " +
							...
							"they’ll be. If you can, try waiting 24 hours.", user10);
			...
			recipe2.addCookbook(cookbook4);
			recipe2.addCookbook(cookbook6);
			recipe2.addCookbook(cookbook8);
			recipe2.addCookbook(cookbook10);
			recipe3.addCookbook(cookbook3);
			recipe3.addCookbook(cookbook1);
			recipe3.addCookbook(cookbook5);
			recipe3.addCookbook(cookbook7);
			recipe3.addCookbook(cookbook9);
			recipe4.addCookbook(cookbook4);
			recipe4.addCookbook(cookbook5);
			recipe4.addCookbook(cookbook1);
			recipe4.addCookbook(cookbook8);
			recipe5.addCookbook(cookbook5);
			recipe5.addCookbook(cookbook2);
			recipe5.addCookbook(cookbook10);
			recipe6.addCookbook(cookbook6);
			recipe6.addCookbook(cookbook2);
			recipe6.addCookbook(cookbook3);
			recipe6.addCookbook(cookbook4);
			recipe6.addCookbook(cookbook7);
			recipe7.addCookbook(cookbook7);
			recipe7.addCookbook(cookbook8);
			recipe7.addCookbook(cookbook9);
			recipe7.addCookbook(cookbook10);
			recipe7.addCookbook(cookbook3);
			recipe7.addCookbook(cookbook4);
			recipe8.addCookbook(cookbook8);
			recipe8.addCookbook(cookbook1);
			recipe8.addCookbook(cookbook2);
			recipe8.addCookbook(cookbook3);
			recipe8.addCookbook(cookbook9);
			recipe8.addCookbook(cookbook4);
			recipe9.addCookbook(cookbook9);
			recipe9.addCookbook(cookbook10);
			recipe9.addCookbook(cookbook1);
			recipe9.addCookbook(cookbook5);
			recipe9.addCookbook(cookbook6);
			recipe9.addCookbook(cookbook2);
			recipe10.addCookbook(cookbook10);
			recipe10.addCookbook(cookbook9);
			recipe10.addCookbook(cookbook8);
			recipe10.addCookbook(cookbook7);
			recipe10.addCookbook(cookbook6);


			recipeRepository.saveAll(List.of(recipe1, recipe2, recipe3, recipe4, recipe5, recipe6, recipe7, recipe8, recipe9, recipe10));
			cookbookRepository.saveAll(List.of(cookbook1, cookbook2, cookbook3, cookbook4, cookbook5, cookbook6, cookbook7, cookbook8, cookbook9, cookbook10));
		};
	}
}
